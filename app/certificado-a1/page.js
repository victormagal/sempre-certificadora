        ...
        <Container newClasses="py-12">
          <div className="col-span-4 lg:col-span-8 lg:col-start-3 flex flex-col space-y-8">
            ...
            <ul className="flex flex-col list-disc ml-4 space-y-3">
              <li>
                <Text appearance="p3" color={neutralMid[500]}>
                  Com o arquivo de exportação criado e enviado ao equipamento
                  mac Os, dê um duplo clique sobre ele.
                </Text>
              </li>
              <li>
                <Text appearance="p3" color={neutralMid[500]}>
                  Serão solicitadas duas senhas. Primeiro, a senha do
                  equipamento e, logo após, a senha do certificado para que ele
                  seja importado para o sistema.
                </Text>
              </li>
            </ul>
          </div>
