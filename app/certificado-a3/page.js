        ...
        >
          <div className="col-span-4 lg:col-span-5 flex flex-col pt-8 lg:pt-0 space-y-4">
            ...
            <Text appearance="p1" color={neutralLight[100]}>
              Tutorial passo a passo de instalação do Certificado A3 para Token
              e Cartão
            </Text>
          </div>
          ...
          <div className="col-span-4 lg:col-span-12">
            <ul className="flex flex-col lg:flex-row flex-grow justify-between space-y-6 lg:space-y-6 lg:space-x-6">
              <li
                ...
                style={{
                  borderColor:
                    selectedToken === 1 ? red[600] : neutralLight[400]
                }}
              >
                <RegularIcon
                  icon="faHardDrive"
              ...
              <li
                ...
                style={{
                  borderColor:
                    selectedToken === 2 ? red[600] : neutralLight[400]
                }}
              >
                <RegularIcon
                  icon="faHardDrive"
              ...
              <li
                ...
                style={{
                  borderColor:
                    selectedToken === 3 ? red[600] : neutralLight[400]
                }}
              >
                <RegularIcon
                  icon="faHardDrive"
              ...
              <li
                ...
                style={{
                  borderColor:
                    selectedToken === 4 ? red[600] : neutralLight[400]
                }}
              >
                <RegularIcon
                  icon="faCreditCard"
              ...
              <li
                ...
                style={{
                  borderColor:
                    selectedToken === 5 ? red[600] : neutralLight[400]
                }}
              >
                <SolidIcon
                  icon="faDesktop"
